...
|------|-------------|--------|
| G1 | Feature has approved spec in `specs/[###-feature]/spec.md` | ☐ |
...
| G7 | Costs, balances, measurements are traceable to source records | ☐ |
| G8 | Financial records use soft delete or reversal — no physical delete | ☐ |
| G9 | Dashboard metrics from consolidated, verifiable data sources | ☐ |

If any gate fails, document justification in Complexity Tracking or resolve before proceeding.
