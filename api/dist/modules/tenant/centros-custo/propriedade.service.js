...
export async function listPropriedades(prisma, entityId) {
...
export async function createPropriedade(prisma, actorId, entityId, input) {
...
export async function updatePropriedade(prisma, actorId, entityId, propriedadeId, input) {
    await assertEntityActive(prisma, entityId);
...
export async function getPropriedadeById(prisma, entityId, propriedadeId) {
    const row = await prisma.centroCustoPropriedade.findFirst({
        where: { id: propriedadeId, entityId },
        include: { createdBy: { select: { id: true, name: true } } },
    });
