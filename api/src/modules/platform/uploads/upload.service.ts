...
export async function saveCoatOfArmsUpload(file: MultipartFile): Promise<string> {
...
async function saveCoatOfArmsFromDataUrl(dataUrl: string): Promise<string> {
...
export async function persistCoatOfArmsUrl(
